...
namespace DatingAppUaa.UnitTests.Pruebas
{
    public class AccountControllerTests
    {
        ...
        public async Task Fail_Register(string statusCode, string username, string knownAs, string gender, DateTime dateOfBirth, string city, string country, string password)
        {
            // Arrange
        ...
        public async Task ReturnOk_Register(string statusCode, string username, string knownAs, string gender, DateTime dateOfBirth, string city, string country, string password)
        {
            // Arrange
            requestUri = $"{apiRoute}/register";
            var registerDto = new RegisterDto
        ...
        public async Task Fail_Login(string statusCode, string username, string password)
        {
            // Arrange
        ...
        public async Task ReturnOK_Login(string statusCode, string username, string password)
        {
            // Arrange
            requestUri = $"{apiRoute}/login";
            var loginDto = new LoginDto
